...
class MybooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mybook" do
    assert_difference('Mybook.count') do
      post mybooks_url, params: { mybook: { city: @mybook.city, city: @mybook.city, email: @mybook.email, name: @mybook.name } }
    end
  ...
  test "should update mybook" do
    patch mybook_url(@mybook), params: { mybook: { city: @mybook.city, city: @mybook.city, email: @mybook.email, name: @mybook.name } }
